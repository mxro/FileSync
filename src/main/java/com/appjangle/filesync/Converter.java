...
public interface Converter {
  ...
  public abstract void createFiles(final NodesMetadata __unknown__, final /* metadata */Object __unknown___1, final Node source, final ValueCallback<List<FileOperation>> cb);
}
