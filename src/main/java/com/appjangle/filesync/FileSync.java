...
public class FileSync {
  ...
  public static void sync(final FileItem folder, final Node node, final ValueCallback<Success> cb) {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\nInvalid number of arguments. The method forEach(List<E>, Closure2<E, ValueCallback<V>>, ValueCallback<List<V>>) is not applicable for the arguments (List<FileItem>,(FileItem, ValueCallback<Success>)=>void)");
  }
