...
public class FileSync {
  ...
  private static void syncInt(final SyncParams params, final /* ValueCallback<Success> */Object cb) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method or field AsyncCommon is undefined for the type FileSync"
      + "\nThe method name is undefined for the type FileSync"
      + "\nThe method onSuccess is undefined for the type FileSync"
      + "\nThe method onSuccess is undefined for the type FileSync"
      + "\nThe method onFailure is undefined for the type FileSync"
      + "\nThe method onSuccess is undefined for the type FileSync"
