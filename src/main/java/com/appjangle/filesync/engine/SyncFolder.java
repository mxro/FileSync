...
public class SyncFolder {
  ...
  public void doIt(final ValueCallback<Success> cb) {
    throw new Error("Unresolved compilation problems:"
      + "\nInvalid number of arguments. The method execute(List<NetworkOperation>, Node, ValueCallback<Success>) is not applicable for the arguments (List<NetworkOperation>,ValueCallback<Object>)"
      + "\nType mismatch: cannot convert from ValueCallback<Object> to Node");
  }
