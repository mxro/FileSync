    ...
    ArrayList<Deferred<?>> _xblockexpression = null;
    {
      ...
      if (_equals) {
        ...
        if (_equals_1) {
          ...
          Query _appendSafe_1 = toNode.appendSafe(_JAVASCRIPT);
          res.add(_appendSafe_1);
          Link _TEMPLATE = this.n.TEMPLATE(session);
          Query _appendSafe_2 = toNode.appendSafe(_TEMPLATE);
          ...
          if (_equals_2) {
            ...
            if (_equals_3) {
              ...
              if (_equals_4) {
                ...
                Query _appendSafe_12 = description.appendSafe(_link);
      ...
      Query _appendSafe_13 = toNode.appendSafe(_link_1);
