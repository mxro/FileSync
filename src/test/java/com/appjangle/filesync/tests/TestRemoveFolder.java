...
public class TestRemoveFolder extends CheckUpdatesTemplate {
  ...
  protected void step6_assertNodesAfterUpdate() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method or field Async is undefined for the type TestRemoveFolder"
      + "\nThe method onFailure is undefined for the type TestRemoveFolder"
      + "\nThe method onSuccess is undefined for the type TestRemoveFolder"
      + "\nThe method onFailure is undefined for the type TestRemoveFolder"
